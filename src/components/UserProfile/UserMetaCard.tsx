    ...
    <>
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6s">
        <div className="flex xl:flex-row justify-between items-center">
          <div className="flex xl:flex-row items-center w-full xl:space-x-6 ">
            ...
            <div className="ml-60 flex flex-row items-center gap-3 order-2 xl:order-3 xl:justify-end">
              <a
          ...
          <button className="flex flex-row rounded-xl items-center border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700" onClick={handleClick}>
